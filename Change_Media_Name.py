...
class UChangeMedia(QDialog):
    ...
    def _setupUi(self):
        ...
        # Form Layout
        #======================================================
        ChangeMedia.setObjectName("ChangeMedia")
        ChangeMedia.resize(330, 195)
        ChangeMedia.setMinimumSize(QtCore.QSize(330, 195))
        ChangeMedia.setSizeGripEnabled(False)
        self.vMainLayout = QtGui.QVBoxLayout(ChangeMedia)
        self.vMainLayout.setObjectName("vMainLayout")
        #======================================================
        # Action/Source/Destination widget
        #======================================================
        self.widgetPrimaryCtrls = QtGui.QWidget(ChangeMedia)
        ...
        # 'Custom' Widget
        #======================================================
        self.groupTemplate = QtGui.QGroupBox(ChangeMedia)
        ...
        # Main Buttons Widget
        #======================================================
        self.widgetMainButtons = QtGui.QWidget(ChangeMedia)
        ...
        self.retranslateUi()
        #------------------------------------------------------
        QtCore.QMetaObject.connectSlotsByName(ChangeMedia)
        #======================================================
        # Setup/Process form
        #======================================================
    ...
    def gui_translate(self, name):
        return QtGui.QApplication.translate("ChangeMedia", name, None, QtGui.QApplication.UnicodeUTF8)

    def retranslateUi(self):
        ChangeMedia = self
        ChangeMedia.setWindowTitle(ChangeMedia.gui_translate("Change Media"))
        self.lblAction.setText(ChangeMedia.gui_translate("Action:"))
        # self.cmbAction.setItemText(0, QtGui.QApplication.translate("ChangeMedia", "Replace", None, QtGui.QApplication.UnicodeUTF8))
        # self.cmbAction.setItemText(1, QtGui.QApplication.translate("ChangeMedia", "Copy After", None, QtGui.QApplication.UnicodeUTF8))
        # self.cmbAction.setItemText(2, QtGui.QApplication.translate("ChangeMedia", "Copy Before", None, QtGui.QApplication.UnicodeUTF8))
        # self.cmbAction.setItemText(3, QtGui.QApplication.translate("ChangeMedia", "Move", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbAction.setItemText(0, QtGui.QApplication.translate("ChangeMedia", "AppendPrefix", None, QtGui.QApplication.UnicodeUTF8))
        self.cmbAction.setItemText(1, QtGui.QApplication.translate("ChangeMedia", "StripPrefix", None, QtGui.QApplication.UnicodeUTF8))
        self.btnInsert.setText(QtGui.QApplication.translate("ChangeMedia", ">>", None, QtGui.QApplication.UnicodeUTF8))
        self.groupTemplate.setTitle(QtGui.QApplication.translate("ChangeMedia", "Template:", None, QtGui.QApplication.UnicodeUTF8))
        self.btnCancel.setText(QtGui.QApplication.translate("ChangeMedia", "Cancel", None, QtGui.QApplication.UnicodeUTF8))
        self.btnOK.setText(QtGui.QApplication.translate("ChangeMedia", "OK", None, QtGui.QApplication.UnicodeUTF8))

        idx = self.cmbAction.currentIndex()

        if idx == 0:   # If Replace
            self.lblSource.setText(QtGui.QApplication.translate("ChangeMedia", "No Use:", None, QtGui.QApplication.UnicodeUTF8))
            self.lblDestination.setText(QtGui.QApplication.translate("ChangeMedia", "Destination:", None, QtGui.QApplication.UnicodeUTF8))
        elif idx == 1: # Copy After
            self.lblSource.setText(QtGui.QApplication.translate("ChangeMedia", "No Use:", None, QtGui.QApplication.UnicodeUTF8))
            self.lblDestination.setText(QtGui.QApplication.translate("ChangeMedia", "Destination:", None, QtGui.QApplication.UnicodeUTF8))
        # elif idx == 2: # Copy Before
        #     self.lblSource.setText(QtGui.QApplication.translate("ChangeMedia", "Copy Field:", None, QtGui.QApplication.UnicodeUTF8))
        #     self.lblDestination.setText(QtGui.QApplication.translate("ChangeMedia", "Before:", None, QtGui.QApplication.UnicodeUTF8))
        # elif idx == 3: # Move
        #     self.lblSource.setText(QtGui.QApplication.translate("ChangeMedia", "Move Field:", None, QtGui.QApplication.UnicodeUTF8))
        #     self.lblDestination.setText(QtGui.QApplication.translate("ChangeMedia", "To:", None, QtGui.QApplication.UnicodeUTF8))
        # elif idx == 4: # Swap
        #     self.lblSource.setText(QtGui.QApplication.translate("ChangeMedia", "Swap Field:", None, QtGui.QApplication.UnicodeUTF8))
        #     self.lblDestination.setText(QtGui.QApplication.translate("ChangeMedia", "With:", None, QtGui.QApplication.UnicodeUTF8))
        # elif idx == 5: # Custom
        #     self.lblSource.setText(QtGui.QApplication.translate("ChangeMedia", "Insert:", None, QtGui.QApplication.UnicodeUTF8))
        #     self.lblDestination.setText(QtGui.QApplication.translate("ChangeMedia", "Destination:", None, QtGui.QApplication.UnicodeUTF8))
        #------------------------------------------------------
    ...
    def onConfirm(self):
        ...
        changeMedia( browser,idx,nids,flds,fld1,fld2,template )
        self.close()


def changeMedia(browser, idx, nids, flds, fldSrc, fldDest, template):
    mw = browser.mw
    mw.checkpoint("ChangeMedia")
    mw.progress.start()
    ...
    def replace(str):
        src_file = str.group(1)
        if idx == 0: #append
            new_file = template + src_file
        elif idx == 1: #strip
            if src_file.startswith(template):
                new_file = src_file[len(template):]
            else:
                new_file = None
        else:
            new_file = None
        if os.path.exists(src_file) and new_file:
            os.rename(src_file, new_file)
            return u"[sound:" + new_file + u"]"
        return str.group(0)

    for nid in nids:
        note = mw.col.getNote(nid)
        #if 0 not in (self.a, self.b) :
        if (fldSrc in note) and (fldDest in note):
            # if idx == 0: #Replace
            note[fldDest] = re.sub(sound_re, replace, note[fldDest])
            # elif idx == 1: #Copy After
...
def onChangeMediaEdit(browser):
    nids = browser.selectedNotes()
    if not nids:
        tooltip("No cards selected.")
        return
    dialog = UChangeMedia(browser, nids)
    dialog.exec_()
...
def setupMenu(browser):
    ...
    menu.addSeparator()
    a = menu.addAction('Change Media Name...')
#    a.setShortcut(QKeySequence("Ctrl+Alt+C"))
    browser.connect(a, SIGNAL("triggered()"), lambda b=browser: onChangeMediaEdit(b))
